...
class ShopViewController: UIViewController {
    ...
    let textArrayShop:[[String]] = [["Mỹ phẩm làm đẹp", "Đặc trị nám và tàn nhang", "Viên thẩm mỹ cao cấp", "Tăng cân & giảm cân", "Nghe nhạc thính phòng", "Xem phim hành động", "Thể thao vua", "Địa điểm du lịch", "Ảnh đẹp thiên nhiên"],
                                    ["Cờ vua", "Trò chuyện cùng người lạ", "Đặt vé máy bay", "Thuốc đông tây", "Phim hay trong tuần", "Lịch phương đông", "Thế giới động vật", "Tư vấn nhà đất", "Bốc bát họ"],
                                    ["Tắm trắng", "Học code cùng nhau", "Các mùa trong năm", "Gia đình số 1", "Iphone", "Vui chơi cùng trẻ", "Shop công nghệ", "Shop làm đẹp", "Tin tức trong nước"]]

    let imgArrayShop:[[String]] = [["1.jpg", "2.jpg", "3.jpg", "4.jpg", "5.jpg", "6.jpg", "7.jpg", "8.jpg", "9.jpg"],
                                   ["21.jpg", "22.jpg", "23.jpg", "15.jpg", "16.jpg", "20.jpg", "12.jpg", "11.jpg", "19.jpg"],
